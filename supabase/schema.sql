...
-- Espejo de 0019_bono_atomico.sql. Mismo patrón que reservar_plaza y
...
-- ═══════════════════════════════════════════════════════════════════
-- P0-15 · Restaurar backup TRANSACCIONAL.
--
-- Antes, restaurar borraba las 44 tablas y reinsertaba como 88 llamadas HTTP
-- independientes: una interrupción entre el borrado y la reinserción dejaba
-- al tenant con datos a medias, sin rollback. Esta función hace TODO en una
-- sola transacción (una función plpgsql es atómica): si algo falla, se
-- revierte entero. Borra en orden inverso de dependencias e inserta en orden
-- directo, igual que hacía el código.
-- ═══════════════════════════════════════════════════════════════════
