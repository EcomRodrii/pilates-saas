-- ═══════════════════════════════════════════════════════════════════════════
-- 0041 · TENTARE — rankear_candidatas: campos extra para la UI premium
-- ═══════════════════════════════════════════════════════════════════════════
--
-- Añade a cada candidata del ranking:
--   'compatibilidad' int 0-100 → barra de la card (derivado del score, acotado)
--   'veces'          int       → "clases impartidas de este tipo" (stat de la card)
-- Mantiene score + motivos. Reversible: CREATE OR REPLACE al cuerpo anterior.
-- ═══════════════════════════════════════════════════════════════════════════
