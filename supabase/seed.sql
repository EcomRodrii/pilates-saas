...
-- ─── Automatizaciones ─────────────────────────────────────────────────────────
-- Sembradas APAGADAS. Venían con activa=true y el cron diario las ejecutaba de
-- verdad sobre el estudio de demostración: intentaba escribir cada mañana a las
-- socias sembradas (16 fallos diarios contra @example.com) y a las direcciones
-- reales que hubiera, en nombre de un estudio que no es de nadie. Un estudio de
-- ejemplo debe SERVIR de ejemplo, no mandar correos.
insert into automatizaciones (id,studio_id,nombre,trigger,accion,asunto,mensaje,activa,ejecutadas,creada_en) values
('auto-1','studio-1','Recordatorio renovación','SUSCRIPCION_EXPIRA_7D','EMAIL','Tu suscripción caduca en 7 días','Hola {nombre}, tu suscripción a {plan} caduca el {fecha}. Renuévala ahora para no perder tu plaza.',false,12,'2026-01-10T09:00:00Z'),
('auto-2','studio-1','Último aviso renovación','SUSCRIPCION_EXPIRA_1D','WHATSAPP','Tu suscripción caduca mañana','Hola {nombre} ⚠️ Tu suscripción caduca mañana. Renuévala en el estudio o responde a este mensaje.',false,8,'2026-01-10T09:00:00Z'),
('auto-3','studio-1','Feliz cumpleaños','CUMPLEANOS','EMAIL','🎂 Feliz cumpleaños, {nombre}!','Muchas felicidades! Como regalo, te regalamos una clase gratis este mes. ¡Úsala cuando quieras!',false,5,'2026-01-15T09:00:00Z'),
('auto-4','studio-1','Bienvenida nueva socia','NUEVA_ALTA','EMAIL','Bienvenida a Pilates Boutique 🎉','Hola {nombre}, ¡bienvenida! Estamos muy contentas de tenerte con nosotras. Tu primera clase está confirmada para {fecha}.',false,8,'2026-01-20T09:00:00Z'),
...
-- ─── Automation Rules ─────────────────────────────────────────────────────────
-- Igual que las de arriba: sembradas apagadas. Se ven, se pueden inspeccionar y
-- encender a mano; lo que no hacen es empezar a escribir solas.
