  ...
  return (
    <PageShell>
      ...
      >
        ...
        <p>Cuando una instructora causa baja, el flujo que describe Tentare en su documentación comercial es automático: el sistema localiza una sustituta disponible, la contacta, confirma el reemplazo y notifica a las alumnas. En el modo por defecto la propietaria solo da el visto bueno a la candidata; en modo autónomo (planes Estudio y Cadena), ni eso. Glofox no dispone de un sistema nativo de sustitución automática documentado públicamente: en la práctica, la coordinación suele hacerse por WhatsApp o por teléfono. Tentare anuncia además un sistema de seguimiento previo que monitoriza las clases próximas y alerta de posibles incidencias antes de que ocurran, lo que permite actuar con antelación en lugar de resolver urgencias a última hora. Estas funcionalidades conviene verificarlas directamente con el proveedor antes de contratar.</p>
