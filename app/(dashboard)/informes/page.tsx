...
export default function Informes() {
  ...
  if (!mounted) {
    return (
      <div className="space-y-6 animate-pulse p-1">
        <div className="h-8 w-56 bg-[#F0E6E4] rounded-lg" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="h-32 bg-white rounded-xl border border-[#F0E6E4]" />
          ))}
        </div>
        <div className="h-72 bg-white rounded-xl border border-[#F0E6E4]" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="h-56 bg-white rounded-xl border border-[#F0E6E4]" />
          <div className="h-56 bg-white rounded-xl border border-[#F0E6E4]" />
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-6" style={{ backgroundColor: '#FDFBFA', minHeight: '100%', padding: '0 0 40px' }}>

      {/* ── Header ─────────────────────────────────────────────────────────── */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-2">
        <div>
          <h1 className="text-2xl font-extrabold tracking-tight" style={{ color: '#2B2429' }}>
            Informes y analítica
          </h1>
          <p className="text-sm mt-0.5 font-medium" style={{ color: '#8B7D82' }}>
        ...
        >
          {PERIOD_OPTS.map(opt => (
            <button
              ...
              className="text-xs font-semibold px-3 py-1.5 rounded-lg transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2B2429]"
              style={period === opt.key
                ? { backgroundColor: '#2B2429', color: '#fff', boxShadow: '0 1px 4px rgba(0,0,0,0.18)' }
                : { color: '#8B7D82', backgroundColor: 'transparent' }
              }
            >
              {opt.label}
            </button>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-[#F0E6E4] rounded-xl p-5">
          ...
          <p className="text-xs font-semibold mb-1" style={{ color: '#8B7D82' }}>Ingresos período</p>
          <p className="text-2xl font-extrabold leading-none" style={{ color: '#2B2429' }}>
            {fmtEurFull(totalIngresos)}
          </p>
          <p className="text-xs mt-1.5 font-medium" style={{ color: '#8B7D82' }}>cobrados en el periodo</p>
        </div>
        ...
        <div className="bg-white border border-[#F0E6E4] rounded-xl p-5">
          ...
          <p className="text-xs font-semibold mb-1" style={{ color: '#8B7D82' }}>MRR</p>
          <p className="text-2xl font-extrabold leading-none" style={{ color: '#2B2429' }}>
            {fmtEurFull(mrr)}
          </p>
          <p className="text-xs mt-1.5 font-medium" style={{ color: '#8B7D82' }}>ingresos mes actual</p>
        </div>
        ...
        <div className="bg-white border border-[#F0E6E4] rounded-xl p-5">
          ...
          <p className="text-xs font-semibold mb-1" style={{ color: '#8B7D82' }}>Ticket medio / miembro</p>
          <p className="text-2xl font-extrabold leading-none" style={{ color: '#2B2429' }}>
            {fmtEurFull(ticketMedio)}
          </p>
          <p className="text-xs mt-1.5 font-medium" style={{ color: '#8B7D82' }}>por miembro en el periodo</p>
        </div>
        ...
        <div className="bg-white border border-[#F0E6E4] rounded-xl p-5">
          ...
          <p className="text-xs font-semibold mb-1" style={{ color: '#8B7D82' }}>Tasa retención</p>
          <p
          ...
          <p className="text-xs mt-1.5 font-medium" style={{ color: '#8B7D82' }}>
      ...
      <div className="bg-white border border-[#F0E6E4] rounded-xl p-6">
        <div className="flex items-start justify-between mb-1">
          <div>
            <h2 className="text-base font-extrabold" style={{ color: '#2B2429' }}>Evolución de ingresos</h2>
            <p className="text-xs mt-0.5" style={{ color: '#8B7D82' }}>Cobros realizados en el periodo seleccionado</p>
          </div>
          <div className="text-right">
            <span className="text-lg font-extrabold" style={{ color: '#2B2429' }}>{fmtEurFull(totalIngresos)}</span>
            <p className="text-xs" style={{ color: '#8B7D82' }}>acumulado</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mb-5 mt-3">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] font-medium" style={{ color: '#8B7D82' }}>Creciendo</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="inline-block w-3 h-3 rounded-sm" style={{ backgroundColor: '#F59E0B' }} />
            <span className="text-[11px] font-medium" style={{ color: '#8B7D82' }}>Estable</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="inline-block w-3 h-3 rounded-sm" style={{ backgroundColor: '#EF4444' }} />
            <span className="text-[11px] font-medium" style={{ color: '#8B7D82' }}>Decreciendo</span>
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          ...
          >
            ...
            {/* X baseline */}
            <line x1={PADDING_L} y1={CHART_H} x2={Math.max(chartW, 480)} y2={CHART_H} stroke="#F0E6E4" strokeWidth="1" />
          </svg>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-[#F0E6E4] rounded-xl p-6">
          <h2 className="text-base font-extrabold mb-0.5" style={{ color: '#2B2429' }}>Ocupación por tipo de clase</h2>
          <p className="text-xs mb-5" style={{ color: '#8B7D82' }}>% plazas ocupadas sobre aforo total en el periodo</p>

          {ocupacionPorTipo.length === 0 ? (
            <div className="flex items-center justify-center h-40">
              <p className="text-sm" style={{ color: '#B0A3A8' }}>Sin sesiones en el periodo</p>
            </div>
          ) : (
                ...
                <div key={tc.id}>
                  <div className="flex items-center justify-between mb-1.5">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-sm font-semibold" style={{ color: '#2B2429' }}>{tc.nombre}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <span className="text-xs" style={{ color: '#8B7D82' }}>{tc.ocupadas}/{tc.aforo}</span>
                      <span
                        className="text-sm font-bold tabular-nums"
                        style={{ color: tc.pct >= 80 ? '#059669' : tc.pct >= 50 ? '#D97706' : '#8B7D82' }}
                      >
                        {tc.pct}%
                      </span>
                    </div>
                  ...
                  <svg width="100%" height="12" style={{ display: 'block' }}>
                    <rect x={0} y={2} width="100%" height={8} rx={4} fill="#F5EFEC" />
                    <rect
                      x={0}
                      y={2}
                      width={`${tc.pct}%`}
                  ...
                  <p className="text-[11px] mt-1" style={{ color: '#B0A3A8' }}>{tc.sesiones} sesiones</p>
                </div>
              ))}
            </div>
          )}
        ...
        <div className="bg-white border border-[#F0E6E4] rounded-xl p-6">
          <h2 className="text-base font-extrabold mb-0.5" style={{ color: '#2B2429' }}>Retención por cohorte</h2>
          <p className="text-xs mb-5" style={{ color: '#8B7D82' }}>Miembros nuevos por mes y su actividad posterior</p>

          {cohortRows.every(r => r.total === 0) ? (
            <div className="flex items-center justify-center h-40">
              <p className="text-sm" style={{ color: '#B0A3A8' }}>Sin datos de cohortes suficientes</p>
            </div>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full text-xs" style={{ borderCollapse: 'separate', borderSpacing: 0 }}>
                <thead>
                  <tr>
                    <th className="text-left font-semibold pb-2 pr-3" style={{ color: '#8B7D82' }}>Mes</th>
                    <th className="text-right font-semibold pb-2 pr-3" style={{ color: '#8B7D82' }}>Altas</th>
                    <th className="text-right font-semibold pb-2 pr-3" style={{ color: '#8B7D82' }}>Act. 30d</th>
                    <th className="text-right font-semibold pb-2 pr-3" style={{ color: '#8B7D82' }}>Act. 90d</th>
                    <th className="text-right font-semibold pb-2" style={{ color: '#8B7D82' }}>% 30d</th>
                  </tr>
                </thead>
                <tbody>
                  {cohortRows.map((row, i) => (
                    <tr
                      key={row.mes}
                      style={{ borderTop: i > 0 ? '1px solid #F5EFEC' : 'none' }}
                    >
                      <td className="py-2 pr-3 font-semibold capitalize" style={{ color: '#2B2429' }}>{row.mes}</td>
                      <td className="py-2 pr-3 text-right tabular-nums" style={{ color: '#2B2429' }}>{row.total}</td>
                      <td className="py-2 pr-3 text-right tabular-nums" style={{ color: '#2B2429' }}>{row.active30}</td>
                      <td className="py-2 pr-3 text-right tabular-nums" style={{ color: row.active90 < 0 ? '#B0A3A8' : '#2B2429' }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* Top 5 socias */}
        <div className="bg-white border border-[#F0E6E4] rounded-xl p-6">
          <h2 className="text-base font-extrabold mb-0.5" style={{ color: '#2B2429' }}>Top 5 miembros</h2>
          <p className="text-xs mb-5" style={{ color: '#8B7D82' }}>Más sesiones asistidas en el periodo</p>

          {topSocias.length === 0 ? (
            <div className="flex items-center justify-center h-32">
              <p className="text-sm" style={{ color: '#B0A3A8' }}>Sin asistencias registradas</p>
            </div>
          ) : (
                ...
                return (
                  <div key={s.id} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold truncate" style={{ color: '#2B2429' }}>
                        {s.nombre} {s.apellidos}
                      </p>
                      <div className="mt-1 h-1.5 rounded-full overflow-hidden" style={{ backgroundColor: '#F5EFEC' }}>
                        <div
        ...
        {/* Clases más populares */}
        <div className="bg-white border border-[#F0E6E4] rounded-xl p-6">
          <h2 className="text-base font-extrabold mb-0.5" style={{ color: '#2B2429' }}>Clases más populares</h2>
          <p className="text-xs mb-5" style={{ color: '#8B7D82' }}>Por número de reservas en el periodo</p>

          {topClases.length === 0 ? (
            <div className="flex items-center justify-center h-32">
              <p className="text-sm" style={{ color: '#B0A3A8' }}>Sin reservas en el periodo</p>
            </div>
          ) : (
              ...
              {topClases.map((tc, i) => {
                ...
                return (
                  <div key={tc.id}>
                    <div className="flex items-center justify-between mb-1.5">
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-bold w-4 text-right" style={{ color: '#B0A3A8' }}>#{i + 1}</span>
                        <span className="w-2.5 h-2.5 rounded-full flex-shrink-0" style={{ backgroundColor: tc.color }} />
                        <span className="text-sm font-semibold" style={{ color: '#2B2429' }}>{tc.nombre}</span>
                      </div>
                      <span className="text-sm font-extrabold tabular-nums" style={{ color: '#2B2429' }}>
                        {tc.count}
                      </span>
                    </div>
                    {/* SVG bar */}
                    <svg width="100%" height="10" style={{ display: 'block' }}>
                      <rect x={0} y={1} width="100%" height={8} rx={4} fill="#F5EFEC" />
                      <rect
                        x={0}
                        y={1}
                        width={`${pct}%`}
      ...
      <div className="bg-white border border-[#F0E6E4] rounded-xl p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h2 className="text-base font-extrabold" style={{ color: '#2B2429' }}>Exportar datos</h2>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold border transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2B2429]"
              style={csvState === 'done'
                ? { backgroundColor: '#D1FAE5', color: '#065F46', borderColor: '#A7F3D0' }
                : { backgroundColor: '#fff', color: '#2B2429', borderColor: '#F0E6E4' }
              }
            >
              <Download size={14} />
            ...
            <button
              ...
              style={pdfState === 'done'
                ? { backgroundColor: '#D1FAE5', color: '#065F46', borderColor: '#A7F3D0' }
                : { backgroundColor: '#2B2429', color: '#fff', borderColor: '#2B2429' }
              }
            >
              <FileText size={14} />
