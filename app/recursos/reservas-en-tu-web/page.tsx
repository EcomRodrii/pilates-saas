  ...
  return (
    <PageShell>
      ...
      >
        ...
        <p>El diseño del widget se adapta a los colores y la identidad visual de tu estudio, y desde el plan Estudio la app de tus alumnas lleva tu nombre, tu logo y tus colores; Tentare solo aparece en una línea discreta de «Reservas seguras con Tentare».</p>
