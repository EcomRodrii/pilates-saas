...
export const ARTICULOS: ArticuloAyuda[] = [
  ...
  },
  {
    ...
    actualizado: '2026-09-15',
    relacionados: ['reservas/crear-una-clase', 'reservas/no-shows', 'problemas/una-reserva-no-aparece', 'reservas/clases-que-se-repiten'],
    estado: 'publicado',
  },
  {
    slug: 'lista-de-espera', categoria: 'reservas', tipo: 'guia',
    titulo: 'Cómo funciona la lista de espera',
    descripcion: 'Cuando se libera una plaza pasa sola a la primera de la lista: al momento o, si tu estudio lo configura, con un plazo para aceptarla.',
  ...
  {
    slug: 'clases-que-se-repiten', categoria: 'reservas', tipo: 'guia',
    titulo: 'Clases que se repiten: la serie y su renovación',
    descripcion: 'Crea de una vez la clase de todas las semanas, mira hasta cuándo llega tu horario en la vista Horario y renuévala antes de que se acabe.',
    terminos: ['serie', 'recurrente', 'clase recurrente', 'repetir', 'renovar', 'horario', 'semanal', 'se acaba'],
    actualizado: '2026-09-16',
    relacionados: ['reservas/crear-una-clase', 'reservas/editar-o-cancelar-una-clase', 'bonos/plazas-fijas', 'configuracion/cierres-del-centro'],
    estado: 'publicado',
  },
  // ─── Clientes y CRM ─────────────────────────────────────────────────────
  {
  ...
  // ─── Instructoras y equipo ──────────────────────────────────────────────
  {
    ...
    actualizado: '2026-09-14',
    relacionados: ['instructores/disponibilidad-y-tarifas', 'instructores/permisos-por-rol', 'instructores/la-app-de-tus-instructoras'],
    estado: 'publicado',
  },
  {
  ...
  },
  {
    ...
    actualizado: '2026-09-21',
    relacionados: ['instructores/disponibilidad-y-tarifas', 'instructores/control-horario', 'instructores/pasar-clases-a-otra'],
    estado: 'publicado',
  },
  {
    slug: 'control-horario', categoria: 'instructores', tipo: 'guia',
    titulo: 'Control horario: jornadas y clases',
    descripcion: 'Contratada o autónoma, cómo empieza cada clase la instructora, qué revisas tú en Tiempo trabajado y cómo afecta a la liquidación.',
    terminos: ['fichaje', 'fichar', 'jornada', 'registro horario', 'empezar clase', 'retraso', 'autonoma', 'contratada', 'tiempo trabajado', 'no la di'],
    actualizado: '2026-09-21',
    relacionados: ['instructores/disponibilidad-y-tarifas', 'instructores/horas-y-contrato', 'instructores/la-app-de-tus-instructoras'],
    estado: 'publicado',
  },
  {
  ...
  },
  {
    ...
    actualizado: '2026-09-16',
    relacionados: ['instructores/dar-de-alta-una-instructora', 'configuracion/usuarios-y-permisos', 'instructores/la-app-de-tus-instructoras'],
    estado: 'publicado',
  },

  {
    slug: 'la-app-de-tus-instructoras', categoria: 'instructores', tipo: 'guia',
    titulo: 'La app de tus instructoras',
    descripcion: 'Tu equipo trabaja desde el móvil: su agenda, pasar lista, su disponibilidad, sus alumnas y los mensajes. Cómo entran la primera vez y qué ve cada una.',
    terminos: ['app instructora', 'equipo', 'pasar lista', 'agenda', 'móvil', 'invitación', 'cómo entra'],
    actualizado: '2026-09-21',
    relacionados: ['instructores/dar-de-alta-una-instructora', 'instructores/permisos-por-rol', 'instructores/disponibilidad-y-tarifas', 'instructores/sustituciones'],
    estado: 'publicado',
  },
  // ─── Pagos y facturación ────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    descripcion: 'Devolver un cobro desde la ficha de la clienta, y cuándo emitir la factura rectificativa.',
    actualizado: '2026-09-15',
  ...
  {
    slug: 'cobrar-en-la-caja', categoria: 'pagos', tipo: 'guia',
    titulo: 'Cobrar en la Caja',
    descripcion: 'El mostrador: montar el ticket, las cinco formas de cobro y qué significa «Cobrado» en cada una.',
    terminos: ['TPV', 'POS', 'caja', 'mostrador', 'datáfono', 'Bizum', 'efectivo', 'importe libre', 'venta'],
    actualizado: '2026-09-14',
    relacionados: ['pagos/abrir-y-cerrar-la-caja', 'pagos/facturas', 'bonos/tipos-de-bono'],
    estado: 'publicado',
  },
  {
    slug: 'abrir-y-cerrar-la-caja', categoria: 'pagos', tipo: 'guia',
    titulo: 'Abrir y cerrar la caja',
    descripcion: 'Fondo inicial, entradas y salidas, y el recuento del cierre: esperado, contado y diferencia.',
    terminos: ['arqueo', 'cierre de caja', 'cuadrar caja', 'fondo', 'cajón', 'efectivo', 'TPV', 'POS'],
    actualizado: '2026-09-08',
    relacionados: ['pagos/cobrar-en-la-caja'],
    estado: 'publicado',
  },
  {
  ...
  },
  {
    ...
    titulo: 'Caducidad y pausa de un bono',
    descripcion: 'Cuándo caduca un bono y cómo pausar su plan mientras una alumna está de baja, sin perder sus sesiones.',
    actualizado: '2026-09-14',
  ...
  },
  {
    ...
    descripcion: 'Ana viene todos los martes a las 10. Cómo se marca una alumna, qué ve ella en su app, cómo se pausa unas semanas, qué pasa si se queda sin cuota y cómo te la piden.',
    terminos: ['plaza fija', 'hueco semanal', 'recurrente', 'sitio fijo', 'reserva recurrente', 'pausar plaza fija', 'vacaciones', 'sin cuota', 'petición de plaza', 'pedir plaza fija', 'marcarse en una clase fija', 'clase fija', 'con bono', 'no puedo asistir', 'próximas clases', 'qué ve la alumna'],
  ...
  },
  {
    ...
    actualizado: '2026-09-14',
    relacionados: ['bonos/caducidad-de-un-bono', 'bonos/recuperaciones', 'configuracion/cierres-del-centro'],
    estado: 'publicado',
  },
  {
    slug: 'renovaciones', categoria: 'bonos', tipo: 'guia',
    titulo: 'Renovaciones automáticas',
    descripcion: 'Cómo y cuándo se cobra una cuota, y qué pasa si el cobro falla.',
    actualizado: '2026-09-14',
  ...
  {
    slug: 'ocultar-tu-pagina', categoria: 'portal', tipo: 'guia',
    titulo: 'Ocultar tu página mientras la preparas',
    descripcion: 'Tu página de reservas y la app de tus alumnas enseñan un aviso en vez de tus clases. Con una clave puedes dejar entrar a quien tú quieras.',
    terminos: ['ocultar', 'privada', 'esconder', 'visible', 'clave', 'en construcción', 'todavía no abro'],
    actualizado: '2026-09-16',
    relacionados: ['portal/que-es-el-portal', 'portal/personalizar-tu-portal', 'widget/que-es-el-widget'],
    estado: 'publicado',
  },
  // ─── Widget ──────────────────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    descripcion: 'Qué avisa Tentare de serie, sin activar nada: recordatorio de clase, bono a punto de acabar, clase cubierta tras una sustitución y más.',
    actualizado: '2026-09-15',
  ...
  // ─── Integraciones ──────────────────────────────────────────────────────
  {
    ...
    descripcion: 'Stripe, Google Calendar, WhatsApp, Zoom, Kisi, Zapier y más: qué hace cada una y cómo se conecta.',
    actualizado: '2026-09-15',
  ...
  // ─── App de tus alumnas ─────────────────────────────────────────────────
  {
    ...
    descripcion: 'Publicas algo desde Mensajería y lo ven en su app: avisos, fotos y eventos, con el público que tú elijas.',
  ...
  },
  {
    ...
    descripcion: 'El logo y el color que ven tus alumnas en tu página de reservas y en su app.',
    actualizado: '2026-09-16',
  ...
  {
    slug: 'cierres-del-centro', categoria: 'configuracion', tipo: 'guia',
    titulo: 'Cerrar el centro: vacaciones, puentes y obras',
    descripcion: 'Vacaciones, un puente o una reforma: se cancelan las clases de esos días, se avisa a quien tenía reserva y los bonos de todas duran esos días más.',
    terminos: ['vacaciones', 'festivos', 'puente', 'cierre', 'cerrar', 'agosto', 'obras', 'reforma'],
    actualizado: '2026-09-16',
    relacionados: ['bonos/ampliar-caducidades-en-lote', 'reservas/clases-que-se-repiten', 'reservas/editar-o-cancelar-una-clase'],
    estado: 'publicado',
  },
  ...
  },
  {
    ...
    descripcion: 'Tarjeta rechazada por el banco, o se queda colgado en "Procesando el pago…".',
    actualizado: '2026-09-14',
