...
const CONTENIDO: Record<string, () => Promise<{ default: ComponentType }>> = {
  ...
  'reservas/clases-que-se-repiten': () => import('@/components/ayuda/articulos/reservas-clases-que-se-repiten'),
  'configuracion/cierres-del-centro': () => import('@/components/ayuda/articulos/configuracion-cierres-del-centro'),
  'instructores/la-app-de-tus-instructoras': () => import('@/components/ayuda/articulos/instructores-la-app-de-tus-instructoras'),
  'portal/ocultar-tu-pagina': () => import('@/components/ayuda/articulos/portal-ocultar-tu-pagina'),
