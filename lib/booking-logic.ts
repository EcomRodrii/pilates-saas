...
// backfill de las que ya existían). OJO: esto cubre el tope de SIMULTÁNEAS,
// que se calcula aquí. El cupo SEMANAL se cuenta en SQL dentro de
// reservar_plaza, que también excluye las clases canceladas de ese conteo.
