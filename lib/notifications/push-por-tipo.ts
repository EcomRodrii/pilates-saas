  ...
  SOCIA: [
    ...
    },
    {
      ...
      tipos: [
        ...
        { evento: EVENTOS.RESERVA_PLAZA_FIJA_NO_MATERIALIZADA, titulo: 'Tu plaza fija no se ha podido reservar' },
        { evento: EVENTOS.PLAZA_FIJA_RESPUESTA, titulo: 'Respuesta a tu petición de plaza fija' },
