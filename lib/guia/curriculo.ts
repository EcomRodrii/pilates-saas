  ...
  // ── 07 ─────────────────────────────────────────────────────────────────────
  {
    ...
    apartados: [
      ...
      },
      {
        ...
        texto: 'Puedes decir que una clase con menos de N apuntadas no sale. Dos horas antes, si no se alcanza, se cancela sola y, como cualquier clase cancelada entera, devuelve la sesión a quien estuviera apuntada salvo que lo hayas desactivado en Configuración → Cómo reservan mis alumnas, en «Cancelar y recuperar». Nadie se planta en el estudio para encontrárselo cerrado.',
      },
      {
