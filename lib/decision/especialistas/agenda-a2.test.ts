...
test('AGENDA A2: muchas clases pasadas casi vacías (sin franja recurrente) → FUSIONAR_SESIONES', () => {
  ...
  const snap: SnapshotEstudio = {
    ...
    recibos: [], suscripciones, planesTarifa: [plan()], tiposClase: [], instructores: [], automationLogs: [], campanas: [], sustituciones: [], instructorTarifas: [], intentosFallidos: [], contexto: { nSociasActivas: 0, antiguedadDatosDias: 999, cadenaId: null, nSedesCadena: 1 },
  };
