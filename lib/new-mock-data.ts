...
export const campanas: Campana[] = [
  ...
  { id: 'camp-2', studioId: 'studio-1', nombre: 'Newsletter junio', tipo: 'EMAIL', asunto: 'Novedades de junio en Pilates Boutique', contenido: 'Este mes hemos añadido nuevas clases de Barre y ampliado el horario de Reformer avanzado.', estado: 'ENVIADA', destinatarios: 'TODAS', enviados: 8, abiertos: 6, clics: 3, creadaEn: '2026-06-01T09:00:00Z', enviadaEn: '2026-06-05T10:00:00Z', programadaEn: null },
  ...
  { id: 'camp-4', studioId: 'studio-1', nombre: 'WhatsApp bienvenida', tipo: 'WHATSAPP', asunto: 'Bienvenida al estudio', contenido: 'Hola {nombre} 👋 Bienvenida a Pilates Boutique. Tu primera clase es el {fecha}. Cualquier duda, estamos aquí.', estado: 'ACTIVA', destinatarios: 'TODAS', enviados: 8, abiertos: 8, clics: 0, creadaEn: '2026-01-01T10:00:00Z', enviadaEn: null, programadaEn: null },
];
...
export const automatizaciones: Automatizacion[] = [
  ...
  { id: 'auto-4', studioId: 'studio-1', nombre: 'Bienvenida nueva socia', trigger: 'NUEVA_ALTA', accion: 'EMAIL', asunto: 'Bienvenida a Pilates Boutique 🎉', mensaje: 'Hola {nombre}, ¡bienvenida! Estamos muy contentas de tenerte con nosotras. Tu primera clase está confirmada para {fecha}.', activa: true, ejecutadas: 8, creadaEn: '2026-01-20T09:00:00Z' },
...
export const postsComunidad: PostComunidad[] = [
  ...
  { id: 'post-3', studioId: 'studio-1', autorId: null, autorNombre: 'Pilates Boutique', autorInicial: 'PB', texto: '📢 Novedad: a partir de julio añadimos una clase de Barre los miércoles a las 19:00. ¡Plazas limitadas! Reservad ya desde el calendario.', likes: 15, comentariosCount: 6, fijado: false, creadoEn: '2026-06-23T09:00:00Z' },
