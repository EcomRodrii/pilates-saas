...
export const FAQS: FaqItem[] = [
  ...
  { categoria: 'Cuenta', pregunta: '¿Cómo cambio los datos de mi estudio?', respuesta: 'En Configuración > Mi estudio, el nombre, el teléfono y la dirección; en Cobros y facturas, el NIF y el IVA; y en Marca, tu logo y, desde «El color de tu marca», tu color.' },
];
