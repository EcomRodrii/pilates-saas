...
export const FAQS: FaqItem[] = [
  ...
  { categoria: 'Portal de clientas', pregunta: '¿Cómo entra una clienta por primera vez?', respuesta: 'Si aún no es clienta tuya, se apunta sola desde tu página pública de reservas: solo necesita su email. Para entrar al portal (/portal/tu-estudio/acceso) escribe su email y su contraseña en la misma pantalla. Si nunca ha creado una —o no se acuerda— ahí mismo tiene "No tengo contraseña o la he olvidado — mándame un enlace": se la manda por correo y la elige ella. También puede entrar con su cuenta de Google, y entonces no tiene que elegir ninguna. Tú no tienes que darle de alta ni enviarle nada.' },
