...
export const FAQS: FaqItem[] = [
  ...
  { categoria: 'Portal de clientas', pregunta: '¿Cómo entra una clienta por primera vez?', respuesta: 'Si aún no es clienta tuya, se apunta sola desde tu página pública de reservas: solo necesita su email. Para entrar al portal (/portal/tu-estudio/login) usa su email y una contraseña que crea ella misma desde "¿Primera vez o olvidaste tu contraseña?". Tú no tienes que darle de alta ni enviarle nada.' },
