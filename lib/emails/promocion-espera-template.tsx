...
export function PromocionEsperaEmail({
  ...
  if (personalizacion?.cuerpo) {
    return (
      <PlantillaEditableEmail
        ...
        preview={`Se ha liberado tu plaza en ${claseNombre}`}
        filas={[
  ...
  return (
    <EmailLayout studioNombre={estudioNombre} logoUrl={logoUrl} colorPrimario={colorPrimario} canales={canales} headerColor="#065F46" titulo="¡Se ha liberado tu plaza!" preview={`Tu plaza en ${claseNombre} ya está confirmada`}>
