...
export function RecordatorioEmail({
  ...
  return (
    <EmailLayout studioNombre={estudioNombre} logoUrl={logoUrl} colorPrimario={colorPrimario} canales={canales} titulo="Recordatorio de tu clase" preview={`Te esperamos en ${claseNombre}`}>
