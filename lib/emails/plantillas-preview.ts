...
import { interpolar, resolverMarcaEstudio, type MarcaEstudio, type TipoPlantillaEditable } from '@/lib/emails/plantillas-server';
...
export async function renderPlantillaMuestra(
  ...
  override: { asunto?: string | null; intro?: string | null },
  marca: MarcaEstudio,
  ...
  const base = { socioNombre: SOCIA_MUESTRA, intro, estudioNombre, ...marca };
