...
| 4b | **Persistir el documento** (el jsonb pasa a `{bloques, orden}`) | La única del plan que necesita migración de datos. Se hace con el modelo ya estabilizado por consumidores reales. |
