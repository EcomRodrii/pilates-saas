...
const VERSIONES = [
  { id: '1', version: '0.38', titulo: 'Renovar el bono en un toque', fecha_publicacion: '2026-09-07', changelog_cambios: [
    { etiqueta: 'NUEVA_FUNCIONALIDAD', texto: 'Tus alumnas renuevan su bono desde la app.', orden: 0 },
    { etiqueta: 'ARREGLO', texto: 'Una reserva podía confirmarse sin descontar la sesión del bono.', orden: 1 },
  ] },
