...
// 10:00–10:50 hora de Madrid (CEST = UTC+2 en agosto) — no UTC. Antes del
// fix de R-3 el formulario leía la hora en la zona del NAVEGADOR, así que
// con el runner de CI en UTC "10:00 UTC" y "10:00 Madrid" coincidían por
// accidente; ahora que openDuplicar ancla a Madrid, el fixture tiene que
// representar la hora real del estudio, no la del runner.
const SESION_ORIGEN = {
