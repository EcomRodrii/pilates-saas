        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-20 px-4">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl border border-[#EBEBF0] overflow-hidden">
                ...
                <div className="mb-1">
                  ...
                  {sociosRes.map(s => (
                    <button key={s.id} onClick={() => go(`/socios/${s.id}`)}
                      ...
                      <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold shrink-0" style={{ backgroundColor: '#EDEAF8', color: '#6B4FA8' }}>
                      ...
                      {(s.tags ?? []).length > 0 && (
                        <span className="text-[10px] font-bold px-2 py-0.5 rounded-full shrink-0" style={{ backgroundColor: '#EDEAF8', color: '#6B4FA8' }}>
                          {s.tags![0]}
                        </span>
                      )}
            ...
            <div className="border-t border-[#EBEBF0] px-4 py-2 flex items-center gap-4">
              <span className="text-[10px] font-medium" style={{ color: '#C4C4CC' }}>
