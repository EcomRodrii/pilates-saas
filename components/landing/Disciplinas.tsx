...
import { DISCIPLINAS, DISCIPLINA_GRADIENTS } from './data';
      ...
      <Reveal delay={100} style={{ maxWidth: 1280, margin: '0 auto', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 16 }}>
        {DISCIPLINAS.map((d, i) => (
          <div
            ...
            style={{ position: 'relative', flexShrink: 0, width: 184, aspectRatio: '3/4', borderRadius: 18, overflow: 'hidden', boxShadow: '0 14px 28px -14px rgba(26,26,26,.28)', background: DISCIPLINA_GRADIENTS[i % DISCIPLINA_GRADIENTS.length] }}
          >
