  ...
  return (
    <>
      ...
      <div
        ...
        style={{ left: 0, right: 0, maxWidth: 640, marginInline: 'auto', backgroundColor: 'var(--card)', borderColor: 'var(--border)' }}
      >
      ...
      <nav
        ...
        style={{ left: 0, right: 0, maxWidth: 640, marginInline: 'auto', backgroundColor: 'var(--card)', borderColor: 'var(--border)', paddingBottom: 'env(safe-area-inset-bottom, 0px)', height: 'calc(56px + env(safe-area-inset-bottom, 0px))' }}
      >
