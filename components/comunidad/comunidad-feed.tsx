...
//
// Extraído de app/(dashboard)/comunidad/page.tsx para que la pestaña
// "Comunidad" dentro de /mensajeria muestre EL MISMO feed real (compositor,
// audiencia, likes/comentarios, lateral con datos reales) en vez de la vista
// de solo lectura que tenía antes — la misma clase de bug que motivó extraer
// ConversacionesTab: dos superficies para lo mismo divergían en cuanto una se
// rediseñaba y la otra no.
//
// Esta pieza tiene los DATOS; la pintura (compositor, tarjeta de post,
