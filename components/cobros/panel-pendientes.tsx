...
export function PanelPendientes({ vista = 'deudas' }: { vista?: 'deudas' | 'cobrado' }) {
  ...
  // segundo clic rapidísimo lee 'confirmar' (stale) antes de que React pinte
  // 'running', pasando el guard dos veces → lote cobrado por duplicado. El ref
  // se pone a true en el mismo tick, así que el segundo clic sale de inmediato.
