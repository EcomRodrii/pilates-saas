...
export function BandejaHoy() {
  ...
  // Reorganización Centro de Control §2 (PR2): ya no es su propia Card
  // detrás del desplegable — vive fusionada dentro de VeredictoDelDia, como
  // el sub-bloque operativo del día. El borde superior es el único
  // separador entre el mensaje del Umbral y esto.
  return (
    <div className="flex w-full flex-col gap-3 border-t border-border pt-4 text-left">
      <div>
        <h3 className="font-heading text-[13px] font-semibold text-foreground">En el estudio hoy</h3>
