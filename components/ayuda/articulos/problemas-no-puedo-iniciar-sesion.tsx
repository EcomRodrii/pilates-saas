...
export default function Contenido() {
  return (
    <>
      <QueEstaPasando>
        No consigues entrar a tu panel de Tentare: contraseña que no funciona, el correo para recuperarla (o el
        código del alta) no llega, o la pantalla se queda cargando sin avanzar.
      </QueEstaPasando>

      <CausasComunes items={[
        'Contraseña incorrecta o olvidada.',
        'El email para recuperar la contraseña (o con el código del alta) ha caído en spam o tarda unos minutos.',
      ...
      <ComoSolucionarlo>
        <p style={{ margin: '0 0 12px' }}>Pulsa «He olvidado mi contraseña» en la propia pantalla de acceso — el enlace tarda normalmente menos de un minuto en llegar.</p>
