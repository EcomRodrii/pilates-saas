  ...
  return (
    <>
      ...
      <ComoSolucionarlo>
        ...
        <p style={{ margin: 0 }}>Si nunca le llega ningún WhatsApp desde Tentare, comprueba en Configuración &gt; Cómo me comunico que tu WhatsApp está conectado — si no lo está, esos avisos se envían solo por email.</p>
      </ComoSolucionarlo>
