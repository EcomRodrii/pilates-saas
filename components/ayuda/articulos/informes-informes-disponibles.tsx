  ...
  return (
    <>
      ...
      <ul style={{ margin: '0 0 20px', paddingLeft: 22, display: 'flex', flexDirection: 'column', gap: 8, fontSize: 15, lineHeight: 1.6 }}>
        ...
        <li><strong>Cuántas siguen viniendo, por mes de alta</strong> — la retención de tus alumnas, agrupadas por cuándo empezaron.</li>
      ...
      <p>Puedes exportar los datos a un archivo que se abre en Excel o Google Sheets, para cruzarlos con tu propia contabilidad si lo necesitas, o descargar el informe en PDF.</p>
