...
// Estilo del portal (tokens de tema); guarda al vuelo vía
// /api/notifications/preferences.
//
// Extraído de app/portal/[slug]/preferencias/page.tsx (vivía como función
// local, sin exportar) para que /ajustes (unificación Perfil/Preferencias/
// Compras) pueda embeberlo tal cual dentro de su propia hoja — un solo
// componente con la lógica de carga/guardado, dos sitios que lo pintan.
...
export function AvisosSocia({ t, studioId }: { t: ModoTokens; studioId: string }) {
